    ...
    if ((param_type == CHIRequestType_DvmOpNonSync)) {
        return MiscNode_Event_DvmTlbi_Initiate;
            ...
            if ((param_type == CHIRequestType_DvmOpSync)) {
                ...
                panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:171: %s.\n", ("Invalid/unexpected CHIRequestType"));
                ;
            }
        }
...
MiscNode_Controller::respToEvent(const CHIResponseType& param_type)
{
    if ((param_type == CHIResponseType_SnpResp_I)) {
        ...
        panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:179: %s.\n", ("Invalid/unexpected CHIResponseType"));
        ;
    }
...
MiscNode_Controller::dataToEvent(const CHIDataType& param_type)
{
    if ((param_type == CHIDataType_NCBWrData)) {
        ...
        panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:187: %s.\n", ("Invalid/unexpected CHIDataType"));
        ;
    }
...
if (!(((*m_blockSize_ptr) >= m_data_channel_size))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:195: %s.\n", "assert failure");
...
if (!((((*m_blockSize_ptr) % m_data_channel_size) == (0)))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:196: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!(((*m_blockSize_ptr) >= m_data_channel_size))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:201: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((((*m_blockSize_ptr) % m_data_channel_size) == (0)))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:202: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((param_tbe != NULL))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:207: %s.\n", "assert failure");
...
if (!((((*m_storDvmTBEs_ptr)).areNSlotsAvailable((1), partition)))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:248: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((param_tbe != NULL))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:269: %s.\n", "assert failure");
