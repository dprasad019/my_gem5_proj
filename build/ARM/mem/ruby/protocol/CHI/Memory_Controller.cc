...
Memory_Controller::checkAllocateTBE(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    DPRINTF(RubyGenerated, "executing checkAllocateTBE\n");
        ...
        if (!(((*in_msg_ptr)).m_allowRetry)) {
            panic("Runtime Error at CHI-mem.sm:462: %s.\n", "assert failure");
...
if (!((((*in_msg_ptr)).m_allowRetry == (false)))) {
    panic("Runtime Error at CHI-mem.sm:477: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((((*m_storTBEs_ptr)).areNSlotsAvailable((1))))) {
    panic("Runtime Error at CHI-mem.sm:488: %s.\n", "assert failure");
...
if (!(((*m_pendingWrites_ptr) >= (1)))) {
    panic("Runtime Error at CHI-mem.sm:513: %s.\n", "assert failure");
...
Memory_Controller::deallocateTBE(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:518: %s.\n", "assert failure");
...
unset_tbe(m_tbe_ptr);;
    if (((((*m_retryQueue_ptr)).empty()) == (false))) {
        #ifndef NDEBUG
        if (!((((*m_storTBEs_ptr)).areNSlotsAvailable((1))))) {
            panic("Runtime Error at CHI-mem.sm:524: %s.\n", "assert failure");
...
Memory_Controller::sendReadReceipt(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:537: %s.\n", "assert failure");
...
Memory_Controller::sendCompDBIDResp(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:549: %s.\n", "assert failure");
...
Memory_Controller::triggerSendMemoryRead(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:559: %s.\n", "assert failure");
...
Memory_Controller::sendMemoryRead(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:567: %s.\n", "assert failure");
...
Memory_Controller::sendMemoryWrite(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:578: %s.\n", "assert failure");
...
Memory_Controller::prepareSend(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:592: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:602: %s.\n", "assert failure");
...
Memory_Controller::sendDataAndCheck(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:610: %s.\n", "assert failure");
...
if (!(((*m_tbe_ptr).m_rxtxBytes < (*m_blockSize_ptr)))) {
    panic("Runtime Error at CHI-mem.sm:611: %s.\n", "assert failure");
...
Memory_Controller::checkForReceiveCompletion(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:644: %s.\n", "assert failure");
...
if (!((((*m_tbe_ptr).m_rxtxBytes <= (*m_tbe_ptr).m_accSize) && ((*m_tbe_ptr).m_rxtxBytes > (0))))) {
    panic("Runtime Error at CHI-mem.sm:646: %s.\n", "assert failure");
...
;
    if (((*m_tbe_ptr).m_rxtxBytes == (*m_tbe_ptr).m_accSize)) {
        ...
        if (!((((*m_tbe_ptr).m_dataBlkValid).getMask((addressOffset((*m_tbe_ptr).m_accAddr, (*m_tbe_ptr).m_addr)), (*m_tbe_ptr).m_accSize)))) {
            panic("Runtime Error at CHI-mem.sm:653: %s.\n", "assert failure");
...
Memory_Controller::getState(Memory_TBE* param_tbe, const Addr& param_addr)
{
    if ((param_tbe != NULL)) {
        ...
        if (!(((*param_tbe).m_addr == param_addr))) {
            panic("Runtime Error at CHI-mem.sm:247: %s.\n", "assert failure");
...
Memory_Controller::setState(Memory_TBE* param_tbe, const Addr& param_addr, const Memory_State& param_state)
{
    if ((param_tbe != NULL)) {
        #ifndef NDEBUG
        if (!(((*param_tbe).m_addr == param_addr))) {
            panic("Runtime Error at CHI-mem.sm:256: %s.\n", "assert failure");
