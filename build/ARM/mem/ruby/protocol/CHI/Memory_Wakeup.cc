 ...
 *   /home/durgpras/gem5/src/mem/slicc/symbols/StateMachine.py:1629
 */
        ...
        if (counter == m_transitions_per_cycle) {
            ...
            try {
                            if ((((*m_rspIn_ptr)).isReady((clockEdge())))) {
                                ...
                                panic("Runtime Error at CHI-mem.sm:361: %s.\n", ("Unexpected message"));
                                ;
                                }
                            }
            ...
            try {
                            if ((((*m_datIn_ptr)).isReady((clockEdge())))) {
                                ...
                                if (!(((((((*in_msg_ptr)).m_bitMask).count()) <= m_data_channel_size) && (((((*in_msg_ptr)).m_bitMask).count()) > (0))))) {
                                    panic("Runtime Error at CHI-mem.sm:372: %s.\n", "assert failure");
                                    ...
                                    if ((((*in_msg_ptr)).m_Type == MemoryRequestType_MEMORY_READ)) {
                                        ...
                                        ;
                                            ...
                                            if ((((*in_msg_ptr)).m_Type == MemoryRequestType_MEMORY_WB)) {
                                                ...
                                                panic("Runtime Error at CHI-mem.sm:390: %s.\n", ("Invalid message"));
                                                ;
                                            }
                                        }
                                        }
            ...
            try {
                            if ((((*m_snpIn_ptr)).isReady((clockEdge())))) {
                                ...
                                panic("Runtime Error at CHI-mem.sm:411: %s.\n", ("Unexpected message"));
                                ;
                                }
                            }
                        } catch (const RejectException & e) {
